#
#  Be sure to run `pod spec lint FLAlertView.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "felarmir"
  # spec.authors            = { "felarmir" => "felarmir@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/felarmir"
