...
//    var title: String?
//    var subTitle: String = "You need to have a title or subtitle to use FLAlertViewSwift 😀"
//
...
//    }
//
//    public func addButton(_ title: String, with action: @escaping ()->Void) {
...
//
//        checkCustomizationValid()
//        //alertView?.frame = setupAlertViewFrame()
//    }
//
//    public func addDoneAction(_ action: @escaping ()->Void) {
//        doneAction = action
//    }
//
...
//            otherButton.addTarget(self, action: #selector(firstButtonPressed(sender:)), for: .touchUpInside)
...
//
//                let horizontalSeparator = UIView(frame: CGRect(
//                    x: alertViewFrame.size.width / 2 - 1,
...
//            secondButton.addTarget(self, action: #selector(secondButtonPressed(sender:)), for: .touchUpInside)
...
//            secondButton.tag = 0
//
//            let firstSeparator = UIView(frame: CGRect(
//                x: 0,
...
//        alertViewVector.frame = CGRect(
//            x: alertViewContents!.frame.size.width / 2 - 15.0,
//            y: -15.0,
//            width: 30.0,
//            height: 30.0)
...
//
//        if let doneAction = firstButtonAction {
//            doneAction()
//        }
//
...
//    }
//
//    @objc private func thirdButtonPressed(sender: UIButton) {
//
//        if let action = thirdButtonAction {
//            action()
//        }
//
//        self.dismissAlertView()
